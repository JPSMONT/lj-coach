...
const TARGETS = [
  ...
  { template: 'ui/trimcheck.template.html', out: 'ui/trimcheck.html', modules: ['trim-shape', 'trim-diagnose', 'stripe-detect', 'calibrate', 'target-library', 'perf-verdict', 'exif', 'session-join'], data: 'data/sail-lj-main.json' },
];
...
const navBar = (active) => `<nav class="ljnav"><a href="index.html" class="brand"><img src="logo-h.png" alt="Little Johnka" /></a>`
