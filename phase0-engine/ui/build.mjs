...
const TARGETS = [
  ...
  { template: 'ui/trimcheck.template.html', out: 'ui/trimcheck.html', modules: ['trim-shape', 'trim-diagnose', 'stripe-detect', 'calibrate', 'target-library'], data: 'data/sail-lj-main.json' },
];
